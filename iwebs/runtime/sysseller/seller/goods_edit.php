	...
	<form action="<?php echo IUrl::creatUrl("/seller/goods_update");?>" name="goodsForm" method="post">
		...
		<div class="module_content" id="table_box_1">
			...
			<fieldset>
                ...
                <div class="box">
                    <!--分类数据显示-->
                    <script id="categoryButtonTemplate" type="textml">
					<ctrlArea>
                    ...
                    <input class="alt_btn" type="button" onclick="selectGoodsCategory('<?php echo IUrl::creatUrl("/block/goods_categorypeeckbox");?>','_goods_category[]')" value="设置分类" />
                </div>
			</fieldset>
			...
			<fieldset>
				...
				<label class="tip">可以上传多张图片，分辨率3000px以下，大小不得超过<?php echo IUpload::getMaxSize();?></label>
