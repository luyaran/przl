		...
		<div class="box clearfix">
			<form action='<?php echo IUrl::creatUrl("/simple/reg_act");?>' method='post'>
				...
				<table class="form_table f_l">
                    ...
                    <tr><th>地图：</th><td><input type='text' class='gray' name='address' pattern='' alt='' /><label></label></td></tr>
                    <tr><th></th><td><div id="allmap"  class='gray' style="width: 600px;height: 300px;"></div><label></label></td></tr>
					...
					<tr><td><input type="hidden" name="uid" value="<?php echo isset($this->uid)?$this->uid:"";?>"/></td><td><input class="submit_reg" type="submit" value="同意一下条款，提交" /><label></label></td></tr>
				</table>
			</form>
