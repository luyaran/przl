...
<link rel="stylesheet" href="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/css/demo.css";?>" type="text/css" />
<script type="text/javascript" charset="UTF-8" src="/iwebs/runtime/_systemjs/jquery/jquery-1.11.3.min.js"></script><script type="text/javascript" charset="UTF-8" src="/iwebs/runtime/_systemjs/jquery/jquery-migrate-1.2.1.min.js"></script>
<script type="text/javascript" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/javascript/awardRotate.js";?>"></script>
	...
	var rotateFn = function (awards, angles, txt){
		...
		$('#rotate').rotate({
			...
			callback:function (){
                $.ajax({
                    type:"post",
                    url:"http://www.przl.com/iwebs/index.php?controller=ucenter&action=make_one",
                    data:{
                        name:txt
                    },
...
<body>
<DIV id=img1 style="Z-INDEX: 100; LEFT: 2px; WIDTH: 59px; POSITION: absolute; TOP: 183px; HEIGHT: 121px;
 visibility: visible;"><img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/pic.gif";?>" width="180" height="180" border="0"></DIV>
<div align="center">
    <p>
        <SCRIPT src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/javascript/js.js";?>"></SCRIPT>
    </p>
</div>
    ...
    <div class="turntable-bg">
        ...
        <div class="pointer"><img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/pointer.png";?>" alt="pointer"/></div>
        <div class="rotate" ><img id="rotate" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/turntable.png";?>" alt="turntable"/></div>
    </div>
