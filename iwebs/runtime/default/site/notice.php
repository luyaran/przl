...
<div class="container">
	...
	<div class="position"> <span>您当前的位置：</span> <a href="<?php echo IUrl::creatUrl("");?>"> 首页</a> » 商城公告 </div>
	...
	<div class="box m_10">
		...
		<div class="content">
		  <ul class="ranklist">
			...
			<?php foreach(Api::run('getCommendHot',10) as $key => $item){?>
	...
	<div class="box m_10">
		...
		<div class="cont">
			...
			<ul class="newslist">
				...
				<?php foreach($queryNotice->find() as $key => $item){?>
				<li><a class="" href="<?php echo IUrl::creatUrl("/site/notice_detail/id/".$item['id']."");?>"><?php echo isset($item['title'])?$item['title']:"";?></a><span>(<?php echo isset($item['time'])?$item['time']:"";?>)</span></li>
				<?php }?>
			</ul>
