	...
	<div class="summary">
		...
		<ul>
			<li>
				...
				<?php if(isset($brand)){?>品牌：<?php echo isset($brand)?$brand:"";?><?php }?>   商家：<?php echo isset($seller_name)?$seller_name:"";?> 地理位置：<?php echo isset($seller_address)?$seller_address:"";?>
			</li>
	...
	<div class="main f_r" style="overflow:hidden">
		...
		<div name="showBox">
			...
			<div>
				...
				<?php }?>
                <div class="salebox">
                    <strong class="saletitle block">产品视频：</strong>
                    <video id="video" src="<?php echo isset($video)?$video:"";?>" width="500" controls="controls"></video>
                </div>
			</div>
			<!-- 商品详情 end -->
...
123
			...
			<div class="hidden box">
				...
				<div class="cont_s gray">
					...
					<!--<?php }?>-->
                    <input type="hidden" value="<?php echo isset($seller_address)?$seller_address:"";?>" name="seller_address"/>
                    <div id="allmap"  class='gray' style="width: 600px;height: 300px;"></div>
                    <div id="driving_way">
                        <select>
...
//    var address=document.getElementsByName("seller_address").value;
//    alert(address);
    ...
    myGeo.getPoint("北京市西城区前细瓦厂胡同6", function(point){
        if (point) {
...
<!--<script type="text/javascript">-->
    <!--// 百度地图API功能-->
    <!--var map = new BMap.Map("allmap");-->
    <!--var seller_address=document.getElementsByName("seller_address").value;-->

    <!--var start = "天安门";-->
    <!--var end = seller_address;-->
