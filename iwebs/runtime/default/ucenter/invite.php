...
<div class="ucenter container">
	...
	<div class="wrapper clearfix">
		<div class="sidebar f_l">
            ...
            <div class="box">
                <div class="title"><h2>好友邀请</h2></div>
                <div class="cont">
                    <ul class="list">
                        <li><a href="<?php echo IUrl::creatUrl("/ucenter/invite");?>">邀请好友</a></li>
                        <li><a href="<?php echo IUrl::creatUrl("/ucenter/integral");?>">邀请历史</a></li>
                    </ul>
                </div>
            </div>
			<div class="box">
		...
		<form action='<?php echo IUrl::creatUrl("/ucenter/doInvite");?>' method='post' name='doInvite'>
    <table class="form_table" width="500" cellpadding="0" cellspacing="0">
        <col width="120px" />
        <col />
        <tr>
            <th>邮箱地址：</th><td><input class="normal" type="text" name="email" pattern='required' alt='请填写邮箱地址' /></td>
        </tr>
        <tr><th></th><td><label class="btn"><input type="submit" value="发出好友邀请" /></label></td></tr>
	</table>
</form>
	</div>
