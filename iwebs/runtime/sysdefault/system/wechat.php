...
<tr name="child<%=menuIndex%>">
	...
	<td><a href="javascript:void(0);" onclick="delChildMenu(this);"><img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_del.gif";?>" alt="删除" title="删除" /></a></td>
</tr>
<%}else{%>
<tr name="parent<%=menuIndex%>">
	...
	<td>
		<a href="javascript:addChildMenu(<%=menuIndex%>,[]);"><img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_add.gif";?>" alt="添加子菜单" title="添加子菜单" /></a>
		<a href="javascript:delParentMenu(<%=menuIndex%>);"><img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_del.gif";?>" alt="删除" title="删除" /></a>
	</td>
</tr>
<%}%>
</script>
