...
<div class="content">
	<?php $skinList = Common::getSitePlan('skin',$theme)?>
	...
	<table class='list_table th_right'>
		...
		<tbody>
			<tr>
				<th rowspan='7'>
					<div class="thumbnail">
						...
						<?php if(Common::isSkinUsed($theme,$key)){?>
			...
			<tr>
				<th>操作：</th>
				<td>
					<a href='<?php echo IUrl::creatUrl("/system/applySkin/skin/".$key."/theme/".$theme."");?>' class='orange'>立即启用</a>
				</td>
			</tr>
		</tbody>
	</table>
