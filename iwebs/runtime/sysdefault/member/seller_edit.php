			...
			<table class="form_table">
				...
				<tbody>
                    ...
                    <tr>
                        <th>详细地址：</th>
                        <td>
                            <input class="normal" name="address" type="text" empty value="" />
                        </td>
                    </tr>
					<tr>
						<th>地图：</th><td><div id="allmap"  class='gray' style="width: 600px;height: 300px;"></div></td>
					</tr>
					<tr>
						<th>客服QQ号码：</th>
...
<script type="text/javascript">
    ...
    map.addEventListener("click", function(e){
        ...
        geoc.getLocation(pt, function(rs){
            ...
            $("input[name='address']").val(addComp.city + addComp.district + addComp.street + addComp.streetNumber);
        });
    });
</script>
