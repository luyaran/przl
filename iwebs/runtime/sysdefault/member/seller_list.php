...
<div class="headbar">
	...
	<div class="operating">
        ...
        <script type="text/javascript" charset="UTF-8" src="/iwebs/runtime/_systemjs/highcharts/highcharts.js"></script>
        <script type="text/javascript" charset="UTF-8" src="/iwebs/runtime/_systemjs/jquery/jquery-1.11.3.min.js"></script><script type="text/javascript" charset="UTF-8" src="/iwebs/runtime/_systemjs/jquery/jquery-migrate-1.2.1.min.js"></script>
    </div>
...
//            $.getJSON("",{});
            $.ajax({
                type:"post",
                url:"<?php echo IUrl::creatUrl("/block/user_list");?>",
                data:{
                    "province":a
                },
                dataType:"json",
...
//                            str +='<td>'
//                            str +='<select onchange="changeStatus(<?php echo isset($item['id'])?$item['id']:"";?>,this)">'
//                            str +='<option value="0" <?php if($item['is_lock'] == 0){?>selected="selected"<?php }?>>正常</option>'
//                            str +='<option value="1" <?php if($item['is_lock'] == 1){?>selected="selected"<?php }?>>待审核</option>'
//                            str +='</select>'
//                            str +='</td>'
                            str +='<td title="'+data[i].create_time+'">'+data[i].create_time+'</td>'
                            str +='<td>'
                            str +='<img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_edit.gif";?>" alt="修改" />'
                            str +='<img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_del.gif";?>" alt="删除" />'
                            str +='</td>'
                            str +='</tr>'
                        }
                        $("tbody").html(str);
        ...
        $(".s").change(function(){
            ...
            var s = $(this).prev().val();
            //alert(s);
            //$.getJSON("<?php echo IUrl::creatUrl("/block/user_li");?>",{"city":a});
            $.ajax({
                type:"post",
                url:"<?php echo IUrl::creatUrl("/block/user_li");?>",
                data:{
                    "province":s,
                    "city":a
                },
...
//                            str +='</td>'
        ...
        $(".d").change(function(){
            ...
            //alert(a);
            //$.getJSON("<?php echo IUrl::creatUrl("/block/user_l");?>",});
            $.ajax({
                type:"post",
                url:"<?php echo IUrl::creatUrl("/block/user_l");?>",
                data:{
                    "province":d,
                    "city":s,
                    "area":a
...
//                            str +='</td>'
        ...
        $("input[name='end_time']").blur(function(){
            ...
            $.getJSON("<?php echo IUrl::creatUrl("/block/search_time");?>",{"start_time":start_time,"end_time":end_time},function(data){
                var str = "";
                if(data){
                    for(var i=0;i<data.length;i++){
                        str +=" <tr>"
...
//            $.ajax({
//                type:"post",
//                url:"<?php echo IUrl::creatUrl("/block/search_time");?>",
//                data:{
