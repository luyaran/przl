	...
	<table id="list_table" class="list_table">
		...
		<tbody>
			...
			<tr id="<?php echo isset($item['id'])?$item['id']:"";?>" parent=<?php echo isset($item['parent_id'])?$item['parent_id']:"";?>>
				<td><img style="margin-left:<?php echo (substr_count($item['path'],',')-2)*2;?>0px" class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/close.gif";?>" onclick="displayData(this);" alt="关闭" /><?php echo isset($item['name'])?$item['name']:"";?></td>
