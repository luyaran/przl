...
<div class="pop_win">
	...
	<script type='text/html' id='specButtonLiTemplate'>
		<li id="specButton<%=item['id']%>">
			...
			<label class="radio"><img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_del.gif";?>" class="delete" title="删除" onclick="delSpec(<%=item['id']%>,this);" /></label>
		</li>
	</script>
				...
				<div class="cont" id="verticalBox" style='display:none'>
					<table class="border_table" width="100%" style="margin-top:0px;">
						...
						<tr class='td_c'>
							...
							<td>
								<img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_asc.gif";?>" onclick="positionUp($(this).parent().parent(),$(this).parent().parent().parent());" alt="向上" />
								<img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_desc.gif";?>" onclick="positionDown($(this).parent().parent(),$(this).parent().parent().parent());" alt="向下" />
								<img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_del.gif";?>" onclick="itemRemove($(this).parent().parent());" alt="删除" />
							</td>
						</tr>
						</script>
					</table>
