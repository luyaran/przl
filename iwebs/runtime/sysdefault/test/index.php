...
<!--<?php if($filename){?>-->
<!--<script type="text/javascript" src="http://www.image.com/getimage.php?filename=<?php echo isset($filename)?$filename:"";?>"></script>-->
<!--<?php }?>-->
<form action="<?php echo IUrl::creatUrl("/test/upfile");?>"  method="post" enctype="multipart/form-data">
<table>
...
<tr>
    ...
    <td>
        ...
        <label>大小不得超过<?php echo IUpload::getMaxSize();?></label>
    </td>
</tr>
