...
<table border="1" align="center">
    <form action="http://www.przl.com/iwebs/index.php/test/sureMake" method="post">
        <tr>
            <td>username</td>
            <td><input type="text" name="name" value="<?php echo isset($item['name'])?$item['name']:"";?>"/></td>
        </tr>
        <tr>
            <td>sex</td>
            <td><input type="text" name="sex" value="<?php echo isset($item['sex'])?$item['sex']:"";?>"/></td>
        </tr>
        <tr>
            <td colspan="2">
