...
<?php foreach($this->list as $key => $item){?>
        <tr>
            ...
            <td><?php echo isset($item['goods_no'])?$item['goods_no']:"";?></td>
            <td>
                <a href="http://www.przl.com/iwebs/index.php/test/del?id=<?php echo isset($item['id'])?$item['id']:"";?>">删除</a>
                &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                <a href="http://www.przl.com/iwebs/index.php/test/upd?id=<?php echo isset($item['id'])?$item['id']:"";?>">修改</a>
            </td>
        </tr>
<?php }?>
    </table>
