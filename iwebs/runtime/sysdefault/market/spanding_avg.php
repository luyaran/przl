...
<div class="headbar">
	...
	<form action='<?php echo IUrl::creatUrl("/market/spanding_avg");?>' method='get'>
		<input type='hidden' name='controller' value='market' />
		<input type='hidden' name='action' value='spanding_avg' />
		<div class="operating">
			<div class="search f_l">
				<input type="text" name='start' empty class="Wdate" id="date_start" pattern='date' value="<?php echo isset($start)?$start:"";?>" alt='' onFocus="WdatePicker()" /> —— <input type="text" empty name='end' value="<?php echo isset($end)?$end:"";?>" pattern='date' class="Wdate" id="date_end" onFocus="WdatePicker()" />
...
{
	var url   = '<?php echo IUrl::creatUrl("/market/spanding_report/start/@start@/end/@end@");?>';
