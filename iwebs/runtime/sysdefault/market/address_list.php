...
<body>
	<div class="container">
		...
		<div id="admin_right">
			<div class="headbar">
	<div class="position"><span>营销</span><span>></span><span>邮件营销管理</span><span>></span><span>邮件营销列表</span></div>
	<div class="operating">
		<a href="javascript:;" onclick="event_link('<?php echo IUrl::creatUrl("/market/address_edit");?>')"><button class="operating_btn" type="button"><span class="addition">添加邮件营销</span></button></a>
...
<div class="content">
	<form method='post' action='#'>
		<table class="list_table">
			<tbody>
            <?php $category_list = Market::address_showtime()?>
            ...
            <tr>
                ...
                <td><?php echo isset($item['sends_num'])?$item['sends_num']:"";?></td>
                <td><a href='<?php echo IUrl::creatUrl("/market/doInvite/id/".$item['id']."");?>'>批量发送</a></td>
            </tr>
            <?php }?>
