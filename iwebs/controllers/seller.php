...
class Seller extends IController
{
	...
	public function goods_edit()
	{
        ...
        $id=$this->seller['seller_id'];
        $arr = $testObj->query("seller_id=$id");
        //var_dump($arr);die;
        $this->list=$arr;
        //var_dump($arr);
		//初始化数据
	...
	function refundment_show()
	{
	 	...
	 	if($refundment_id)
	 	{
	 		...
	 		$tb_refundment->fields = 'o.order_no,o.create_time,u.username,c.*,o.*,c.id as id,c.pay_status as pay_status';
